...
class CombinedExperienceAgent:
    def __init__(self):
        ...
        self.clarification_prompt = PromptTemplate(
            input_variables=["checkpoints", "resume", "date_analysis"],
            template= """
...
**Guidelines** : Ensure that the factual clarifications should adhere to each of the following guidelines:
    ...
    2) Career Stability and Gaps: - Study the chronology of job switches and calculate any gap of more than two months between job switches between companies(not projects).
...
7) Important : While evaluating years of professional experience, consider the context of the role, current position, match with responsibilities handled by the candidate, etc., taking a holistic and pragmatic approach. 
a. For roles requiring 1-5 years of experience, a candidate with 1-2 years less experience also may be suitable, if the resume demonstrating strong alignment in other areas. Candidates with a couple of  years higher experience also may be considered to be a match unless they are overqualified because of other factors. 
b. For roles requiring over 5 years, a shortfall of approximately 20% in experience might be acceptable if other aspects of their profile are highly relevant. Candidates with a couple of  years higher experience also may be considered to be a match unless they are overqualified because of other factors. 
...
### Output Format:
    ...
    """
        ...
        self.evaluation_prompt = PromptTemplate(
            input_variables=["job_description", "candidates_profile", "checkpoints", "answer_script", "date_analysis"],
            template="""
...
1) Step 1. **Understand the Job Description and Candidate's Profile (Focus on Experience and Applied Skills):**
    ...
    D. While evaluating years of professional experience, consider the context of the role, current position,match with responsibilities handled by the candidate, etc., taking a holistic and pragmatic approach. 
i. For roles requiring 1-5 years of experience, a candidate with 1-2 years less experience also may be suitable, if the resume demonstrating strong alignment in other areas. Candidates with a couple of  years higher experience also may be considered to be a match unless they are overqualified because of other factors. 
ii. For roles requiring over 5 years, a shortfall of approximately 20% in experience might be acceptable if other aspects of their profile are highly relevant. Candidates with a couple of  years higher experience also may be considered to be a match unless they are overqualified because of other factors. 
...
B. While evaluating the years of professional experience checkpoint, do not go by the number of years too strictly. Consider the overall experience, the quality of experience, and other relevant factors to give some favorable consideration if the number of years slightly falls short of the requirement or if it exceeds the requirement by not a significant margin, keeping in mind the flexibility mentioned in Step 1.D.
...
D. **Give higher weightage to current and most recent assignments while evaluating professional experience and skills. Reduce ratings proportionately if the key responsibilities of recent roles are unrelated to the JD, even if older experiences align well. Conversely, if the candidate's current or most recent role is very similar to the job they are applying for, this can positively influence the rating.**
